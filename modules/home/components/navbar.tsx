                ...
                <div className="px-6 py-4 flex justify-between items-center">
                    <Link href={"/"} className="flex items-center gap-2">
                        <svg width="20" height="20" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width="200" height="200" rx="40" fill="#2C3E50" />
                            <path d="M60 100L90 130L140 70" stroke="#2ECC71" strokeWidth="16" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M40 70L70 40" stroke="#E74C3C" strokeWidth="16" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M160 130L130 160" stroke="#3498DB" strokeWidth="16" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
